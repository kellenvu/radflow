...
<main class="p-6 min-h-screen bg-gradient-to-b from-[#ffffff] to-[#6ec5ff]">
  ...
  <div class="flex justify-between items-end mb-6">
    ...
    <div class="flex items-center gap-2">
      <button class="frosty-glass px-3 py-1 text-xl" on:click={() => adjustDate(-1)}>❮</button>
    ...
    <div class="w-2/3 relative">
      ...
      <div class="flex flex-col gap-5">
        {#each studies as study}
          <div class="relative">
            <!-- Dot -->
            <div class="absolute left-4 top-6 w-2 h-2 rounded-full bg-black -translate-x-1/2"></div>
